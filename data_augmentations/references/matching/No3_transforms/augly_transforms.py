...
# 将图片随机叠加到一张背景图上（背景是从原背景上裁减下来的一部分）
...
class AutoAug(object):
    def __init__(self):
        self.policies = [pth_transforms.AutoAugmentPolicy.CIFAR10, 
                        pth_transforms.AutoAugmentPolicy.IMAGENET, 
                        pth_transforms.AutoAugmentPolicy.SVHN]
